"""
Django settings for Rachit's CV Builder & ATS Checker
"""
...
# Use SQLite for simplicity on Render (or PostgreSQL if configured)
DATABASES = {
    'default': {
...
# Free Groq API (LLaMA) for ATS scoring - get key at console.groq.com
